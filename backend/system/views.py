...
class MenuView(APIView):
    """
    Returns menu structure for the current user
    """
            ...
            },
            {
                ...
                "children": [
                    {"key": "product-product-list", "title": "商品列表", "path": "/product/product-list", "pageCode": "product-product-list"},
                    {
                        ...
                        "title": "商品产品开发",
                        "children": [
                            {"key": "product-double-star", "title": "内贸", "path": "/product/double-star", "pageCode": "product-double-star"},
                            {"key": "product-white-label", "title": "跨境", "path": "/product/white-label", "pageCode": "product-white-label"}
                        ]
                    },
